...
class TBSCertificate {
    ...
    static fromElement(value) {
        ...
        signature = AlgorithmIdentifier_1.default.fromElement(tbsCertificateElements[encounteredElements++]);
        issuer = InformationFramework_1.RDNSequence.fromElement(tbsCertificateElements[encounteredElements++]);
        validity = Validity_1.default.fromElement(tbsCertificateElements[encounteredElements++]);
        subject = InformationFramework_1.RDNSequence.fromElement(tbsCertificateElements[encounteredElements++]);
        subjectPublicKeyInfo = SubjectPublicKeyInfo_1.default.fromElement(tbsCertificateElements[encounteredElements++]);
                    ...
                    case (3): {
                        ...
                        extensionElements.forEach((extensionElement) => {
                            if (typeof extensions === "undefined")
                                extensions = [];
                            extensions.push(Extension_1.default.fromElement(extensionElement));
                        });
                        break;
                    }
                    default: break;
